...
public class RutinaDiariaNivel8 implements RutinaEspecifica {
	...
	public void armarListaEjercicios() {
		...
		ejercicio1.setRepeticiones("30 repeticiones");
		...
		ejercicio2.setDescripcion(
				"Realiza un fondo en paralelas convencional pero cada vez que termines una repetición hazlo de manera explosiva, consiguiendo que las manos se despeguen de las barras.");
		ejercicio2.setVideo("fondos_explosivos.mp4");
		ejercicio2.setRepeticiones("20 repeticiones");
		...
		ejercicio3.setDescripcion(
				"Realiza una flexión de pecho convencional pero cada vez que termines una repetición hazlo de manera explosiva, consiguiendo que las manos se despeguen del piso y aplaudiendo en ese momento.");
		ejercicio3.setVideo("flexiones_palmada.mp4");
		ejercicio3.setRepeticiones("20 repeticiones");
		...
		ejercicio4.setDescripcion(
				"Colócate en las paralelas con los codos bloqueados y realiza una flexión de brazos hasta completar un ángulo de 90°");
		ejercicio4.setVideo("fondos.mp4");
		ejercicio4.setRepeticiones("25 repeticiones");
		...
		ejercicio5.setDescripcion(
				"Manos en el suelo, apertura cerrada manos en forma de diamante, espalda recta y realizar el movimiento controlado.");
		ejercicio5.setVideo("flexiones_diamante.mp4");
		ejercicio5.setRepeticiones("30 repeticiones");
		...
		ejercicio6.setDescripcion(
				"Manos en el suelo, apertura abierta amplia con respecto a sus hombros, espalda recta y realizar el movimiento controlado");
		ejercicio6.setVideo("flexiones_abiertas.mp4");
		ejercicio6.setRepeticiones("35 repeticiones");
		...
		ejercicio8.setDescripcion(
				"Colócate en la parte superior de la barra, con los codos bloqueados y realiza una flexión de brazos hasta completar un ángulo de 90°");
		ejercicio8.setVideo("fondos_barra.mp4");
		ejercicio8.setRepeticiones("20 repeticiones");
		...
		ejercicio9.setDescripcion(
				"En posición de flexión de pecho convencional, vas a realizar la flexión de un solo brazo mientras el otro lo bloqueas totalmente hasta tocar el piso con el pecho y así ir alternando cada brazo. ");
		ejercicio9.setVideo("flexiones_arqueras.mp4");
		ejercicio9.setRepeticiones("20 repeticiones");
		...
		ejercicio10.setRepeticiones("10 repeticiones");
		...
		ejercicio11.setDescripcion(
				"En una barra de dominadas, quédate colgando en agarre prono, con las piernas estiradas totalmente paralelas al suelo y flexiona los brazos hasta que la barbilla supere la altura de la barra. ");
		ejercicio11.setVideo("dominadas_l.mp4");
		ejercicio11.setRepeticiones("10 repeticiones");
		...
		ejercicio12.setDescripcion(
				"Realiza dominadas con potencia suficiente para que al llegar a la barra tu pecho vaya hacia la misma y las manos se despeguen ligeramente de la misma.");
		ejercicio12.setVideo("dominadas_explosivas.mp4");
		ejercicio12.setRepeticiones("9 repeticiones");
		...
		ejercicio14.setDescripcion(
				"En cada repetición la barbilla va a tocar una de las manos, esto hace que el esfuerzo se centre más en uno de los brazos. ");
		ejercicio14.setVideo("dominadas_asimetricas.mp4");
		ejercicio14.setRepeticiones("9 repeticiones a cada lado");
		...
		ejercicio16.setDescripcion(
				"Realiza una dominada prona convencional, pero al bajar aguanta la posición unos segundos justo cuando tu cabeza esté debajo de la barra, sube de nuevo hasta que la barbilla pase la barra y baja por completo para completar una repetición.");
		ejercicio16.setVideo("dominadas_parada_mitad.mp4");
		ejercicio16.setRepeticiones("10 repeticiones");
		...
		ejercicio18.setDescripcion(
				"Con el empeine de un pie apoyado en un banco o barra baja, colocarse en posición de zancada y realizar repeticiones. ");
		...
		ejercicio19.setDescripcion(
				"Colocarse tumbado en el suelo boca arriba, flexionar rodillas y levantar la cadera hasta que la espalda quede alineada con los muslos.");
		...
		ejercicio20.setDescripcion(
				"Realizar sentadillas, pero bajando lo máximo posible, superando de largo los 90º, añade trabajo de femorales y glúteos.");
		...
		ejercicio21.setDescripcion(
				"Colocarse en el borde de un escalón o barra baja, a la pata coja contraer el gemelo para ponerse de puntillas y luego volver a bajar.");
		...
		ejercicio22.setDescripcion(
				"En una barra baja, colócale por debajo para hacer un movimiento de remo con agarre supino, llevando la barra a la frente.");
		ejercicio22.setVideo("autralian_chin_ups.mp4");
		ejercicio22.setRepeticiones("25 repeticiones");
		...
		ejercicio23.setDescripcion(
				"En una barra de dominadas, quédate colgando en agarre supino y flexiona los brazos hasta que la barbilla supere la altura de la barra.");
		...
		ejercicio24.setRepeticiones("10 repeticiones");
		...
		ejercicio25.setDescripcion(
				"en posición de flexión con las manos a una altura superior que la de sus pies y en una barra baja, realizar una flexión sin abrir sus codos hasta que los codos pasen por debajo de la barra. ");
		ejercicio25.setVideo("flexiones_enterradoras.mp4");
		ejercicio25.setRepeticiones("15 repeticiones");
		...
		ejercicio26.setDescripcion(
				"en posición de flexiones, flexionar el brazo hasta que el antebrazo toque por completo el piso y volver a subir.");
		ejercicio26.setVideo("extension_triceps.mp4");
		ejercicio26.setRepeticiones("25 repeticiones");
		...
		ejercicio27.setRepeticiones("15 repeticiones");
		...
		ejercicio28.setDescripcion(
				"Haz un impulso a pino y mantén el equilibrio sin mover las manos, ayúdate controlando con los hombros, codos y muñecas. ");
		ejercicio28.setVideo("pino.mp4");
		ejercicio28.setRepeticiones("20 repeticiones");
		...
		ejercicio29.setDescripcion(
				"Haz pino y realiza flexiones con los brazos, al principio el rango era corto, pero con el tiempo intenta aumentar hasta hacer el rango completo.");
		...
		ejercicio30.setDescripcion(
				"Desde la posición de pino, sin arquear la espalda, flexiona los brazos y a la vez deja que el cuerpo baje hasta colocarse en un ángulo de 45° con respecto al suelo, para completar el movimiento vuelve a estirar los brazos y a la vez lleva el cuerpo a la vertical.");
		ejercicio30.setVideo("45_push_ups.mp4");
		ejercicio30.setRepeticiones("8 repeticiones");
		...
		ejercicio31.setDescripcion(
				"Acerca las manos y los pies, levantando la cadera y realiza flexiones con la cabeza entre los brazos.");
		ejercicio31.setVideo("flexiones_pike.mp4");
		ejercicio31.setRepeticiones("20 repeticiones");
		...
		ejercicio32.setDescripcion(
				"Colócate en posición de tucked planche y abre un poco las rodillas hasta que sobrepasen los brazos y mantén la posición por el tiempo determinado e intentando no tocar el suelo con los pies.");
		...
		ejercicio33.setDescripcion(
				"En posición de fondos convencionales, genera una inclinación de 45° con el cuerpo y realiza la flexión.");
		ejercicio33.setVideo("fondos_inclinados.mp4");
		ejercicio33.setRepeticiones("15 repeticiones");
		...
		ejercicio34.setDescripcion(
				"En una barra cercana al suelo, boca arriba con la cabeza cerca de la misma, utiliza un agarre supino y quédate en un ángulo de 45°, con ambas piernas estiradas y apoyando en el suelo solo la parte alta de la espalda.");
		ejercicio34.setVideo("dragon_flag.mp4");
		ejercicio34.setRepeticiones("");
		...
		ejercicio35.setRepeticiones("30 segundos");
		...
		ejercicio36.setDescripcion(
				"Desde la posición de flexiones, adelanta un pie cada vez, como si estuvieras intentando correr, intenta mantener la cadera en una posición fija, ");
		...
		ejercicio37.setDescripcion(
				"Colócate boca arriba en el suelo, apoyando solamente en la parte superior de los glúteos y con las rodillas flexionadas, une las manos frente a tu pecho en posición de rezo y gira el torso de un lado a otro.");
		...
		ejercicio38.setDescripcion(
				"Colócate en el suelo apoyando las puntas de los pies y todo el antebrazo, mantén esa posición por un tiempo determinado, mantén la espalda recta con respecto a las piernas y el cuello en posición neutra.");
		ejercicio38.setVideo("plancha_abdominal.mp4");
		ejercicio38.setRepeticiones("30 segundos");
