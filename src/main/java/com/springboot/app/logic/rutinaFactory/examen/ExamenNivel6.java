...
public class ExamenNivel6 implements RutinaEspecifica {
	...
	public void armarRutina() {
		...
		ejercicio7.setDescripcion(
				"Haz pino contra la pared y flexiona los brazos hasta que tu frente roce el suelo, vuelve a subir hasta estirar los brazos por completo.");
		...
		ejercicio8.setDescripcion(
				"Haz un impulso a pino y mantén el equilibrio sin mover las manos, ayudate controlando con los hombros, codos y muñecas.");
